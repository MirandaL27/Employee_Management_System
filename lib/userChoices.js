...
const questions = [
    {
        ...
        choices: ['View all departments','View all roles', 'View all employees', 'Add a department', 'Add a role', 'Add an employee', 'Update an employee role', 'View employees by department', 'View total budget of department', 'View employees by manager', 'Delete department', 'Delete role', 'Exit']
    }
];
